...
Make the app yours by updating the theme and assets.

### 🎨 Colors
Edit \`src/constants/Colors.ts\` to match your brand:
\`\`\`typescript
export default {
  primary: '#FF5A5F', // Classic Rental Red
  secondary: '#00A699',
  accent: '#FC642D',
  background: '#FFFFFF',
  text: '#222222',
...
### 🖼 Assets
Replace the following files for instant branding:
- **Logo:** \`src/assets/images/logo.png\`
- **Splash:** \`src/assets/images/splash.png\`
- **Icons:** \`assets/icon.png\` (1024x1024)

### Fonts
BookHere uses Google Fonts by default. To change them, modify the \`App.tsx\` font loader configuration.
    `
  },
  faq: {
    title: "FAQ",
